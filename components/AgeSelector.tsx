  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col justify-center items-center p-4">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <AgeGroupCard ageGroup={AgeGroup.KID} onSelect={() => context?.selectAgeGroup(AgeGroup.KID)} />
        <AgeGroupCard ageGroup={AgeGroup.TWEEN} onSelect={() => context?.selectAgeGroup(AgeGroup.TWEEN)} />
        <AgeGroupCard ageGroup={AgeGroup.TEEN} onSelect={() => context?.selectAgeGroup(AgeGroup.TEEN)} />
      </div>
    </div>
  );
};
