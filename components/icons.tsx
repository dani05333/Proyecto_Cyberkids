...
export const UserGroupIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.51.056 1.02.083 1.53.083h.094m-9.302 0h9.302c.51 0 1.02.027 1.53.083m-9.302 0a9.094 9.094 0 013.741-.479 3 3 0 014.682-2.72M6.75 9.75h.008v.008H6.75V9.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM12.75 9.75h.008v.008h-.008V9.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm5.625 0h.008v.008h-.008V9.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
  </svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.125 1.125 0 01-1.59 0l-3.72-3.72c-1.133-.093-1.98-1.057-1.98-2.193v-4.286c0-.97.616-1.813 1.5-2.097m6.75-3.668l-3.72 3.72a1.125 1.125 0 01-1.59 0l-3.72-3.72V4.5c0-1.136.847-2.1 1.98-2.193l3.72-3.72a1.125 1.125 0 011.59 0l3.72 3.72c1.133.093 1.98 1.057 1.98 2.193v4.286z" />
    </svg>
);
...
export const TrophyIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9 9 0 119 0zM19.5 18.75h-15a2.25 2.25 0 00-2.25 2.25v.75A2.25 2.25 0 004.5 24h15a2.25 2.25 0 002.25-2.25v-.75a2.25 2.25 0 00-2.25-2.25zM12 15V9m0 0l-2.25 2.25M12 9l2.25 2.25M12 3.75v1.5m0 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0" />
  </svg>
);
...
export const PuzzlePieceIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M21 7.5l-2.25-1.313M21 7.5v2.25m0-2.25l-2.25 1.313M3 7.5l2.25-1.313M3 7.5l2.25 1.313M3 7.5v2.25m9 3l2.25-1.313M12 12.75l-2.25-1.313M12 12.75V15m0-2.25l2.25 1.313M12 12.75l-2.25 1.313M9 10.5v2.25m6-2.25v2.25m-3-3.75l-2.25-1.313M12 9l2.25-1.313M12 9V6.75m-3 3.75l2.25-1.313M9 10.5l2.25-1.313" />
  </svg>
);
...
export const RocketLaunchIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.82m5.84-2.56a14.953 14.953 0 00-5.84-7.38m5.84 7.38l-2.86-2.86m0 0a14.929 14.929 0 00-2.86-.51m-4.33 4.33a14.929 14.929 0 00-.51 2.86m-2.86-2.86a14.929 14.929 0 00-2.86.51m4.33-4.33a14.953 14.953 0 00-7.38-5.84m7.38 5.84l-2.86 2.86m0 0a14.929 14.929 0 00-.51 2.86m2.86-2.86a14.929 14.929 0 00.51-2.86m-4.33 4.33a14.953 14.953 0 007.38 5.84m-7.38-5.84l2.86-2.86" />
  </svg>
);
